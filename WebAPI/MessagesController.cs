...
namespace WebAPI
{
    ...
    {
        [HttpGet("all")]
        public async Task<IActionResult> GetAllMessages() => Ok(await cosmosDbService.GetAllMessages());
        ...
        [HttpGet("count")]
        public async Task<IActionResult> GetTotalMessageCount() => Ok(await cosmosDbService.GetTotalMessageCount());

        [HttpGet("statistics")]
        public async Task<IActionResult> GetStatistics() => Ok(await cosmosDbService.GetStatistics());
    }
